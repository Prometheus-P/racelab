...
export default function Home({ searchParams }: { searchParams: { tab?: string } }) {
  ...
  // FAQ Schema for AEO optimization (확장된 10+ 질문)
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '출마표에서는 출전 마필/선수의 번호, 이름, 기수(경마), 최근 성적, 마체중, 부담중량 등의 정보를 확인할 수 있습니다. 이 정보들은 경주 예측에 중요한 참고 자료입니다.',
        },
      },
    ],
  };

  // HowTo Schema for beginner guide
  const howToSchema = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: '경주 관람 방법',
