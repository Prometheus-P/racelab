...
export function ResultsList({
  ...
  if (results.items.length === 0) {
    return (
      <div className="py-12 text-center text-on-surface-variant" data-testid="empty-state">
        <div className="mb-2 text-headline-small">결과가 없습니다</div>
        <div className="text-body-medium">다른 날짜나 필터를 선택해 보세요.</div>
      </div>
    );
  }
  ...
  return (
    <div data-testid={testId}>
      {/* Total Count */}
      <div className="mb-4 text-body-medium text-on-surface-variant" data-testid="total-count">
